...
abstract class AbstractEntryRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'Zikula\MultiHookModule\Entity\EntryEntity';
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved entryEntity instances
     */
     ...
     * @param integer $excludeId  Id of entries to exclude (optional)
     *
