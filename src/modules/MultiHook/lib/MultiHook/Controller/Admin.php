...
class MultiHook_Controller_Admin extends Zikula_AbstractController
{
    ...
    public function main()
    {
        ...
        return $form->execute('mh_admin_config.html', new MultiHook_Handler_ModifyConfig());
    }
    ...
    public function edit()
    {
        ...
        // Return the output that has been generated by this function
        return $form->execute('mh_admin_edit.html', new MultiHook_Handler_Edit());
    }
    
    /**
     * view items
     *
     *@params filter (int) 0=abbr, 1=acronyms, 2=links, 3=censor
     */
    public function view()
    {
        ...
        for($cnt=0; $cnt<count($abacs); $cnt++ ) {
            ...
            if (SecurityUtil::checkPermission('MultiHook::', "$abacs[$cnt][shortform]::$abacs[$cnt][aid]", ACCESS_EDIT)) {
                $abacs[$cnt]['edit'] = true;
                if (SecurityUtil::checkPermission('MultiHook::', "$abacs[$cnt][shortform]::$abacs[$cnt][aid]", ACCESS_DELETE)) {
