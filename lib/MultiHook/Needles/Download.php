...
class MultiHook_Needles_Download extends Zikula_AbstractHelper
{
    /**
     * wave needle
    ...
    {
        $info = array('info'          => 'DOWNLOAD{C-downloadcategoryid|D-downloadid|L-downloadid|S}',   // possible needles
                      'description'   => $this->__('Link to a download or a category stored in the Downloads module'),
                      'casesensitive' => true,
                      'needle'        => 'DOWNLOAD',
                      'inspect'       => false);
        return $info;
