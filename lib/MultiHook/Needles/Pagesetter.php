...
class MultiHook_Needles_Pagesetter extends Zikula_AbstractHelper
{
    public function info()
    {
        $info = array('info'          => 'PAGESETTER{tid}{-pid}',   // possible needles
                      'description'   => $this->__('Link to a publiction or list of publications stored in Pagesetter'),
                      'casesensitive' => true,
                      'needle'        => 'PAGESETTER',
                      'inspect'       => false);
        return $info;
