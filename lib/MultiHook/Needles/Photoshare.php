...
class MultiHook_Needles_Photoshare extends Zikula_AbstractHelper
{
    public function info()
    {
        $info = array('info'          => 'PHOTOSHARE{A-albumid|P-pictureid|T-pictureid}',   // possible needles
                      'description'   => $this->__('Link to a album/picture/thumbnail stored in Photoshare'),
                      'casesensitive' => true,
                      'needle'        => 'PHOTOSHARE',
                      'inspect'       => false);
        return $info;
