...
define('_MH_ADMINTITLE','Links, Abbreviations, Acronyms, Censor and Needles');
...
// D
//
define('_MH_DELETE','Delete entry');
define('_MH_DELETED','Entry deleted');
...
define('_MH_MODIFYCONFIG','Modify Configuration');
